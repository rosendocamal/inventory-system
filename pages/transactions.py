...
st.set_page_config(page_title="Listar productos", page_icon=":material/contract:")
...
with st.form("list_products"):
    ...
    if submitted:
        ...
        if info_transactions["status"] is False:
            ...
            all_transactions: list[dict[str, str | int]] = info_transactions[
                "transactions"
            ]
            ...
            for index, transaction in enumerate(all_transactions):
                ...
                transaction_df["CÓDIGO DE PRODUCTO"].append(
                    transaction["affected_product_code"]
                )
                transaction_df["FECHA DE TRANSACCIÓN"].append(
